...
const TABLE_DETAILS = {
    // ТЕРРАСА (Столы 1-10)
    '1': { title: 'Стол 1 (8 чел.)', desc: 'Просторный стол для большой компании у окна террасы.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+1' },
    '2': { title: 'Стол 2 (8 чел.)', desc: 'Просторный стол для большой компании у окна террасы.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+2' },
    '3': { title: 'Стол 3 (4 чел.)', desc: 'Прямоугольный стол у стены, подходит для семьи.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+3' },
    '4': { title: 'Стол 4 (4 чел.)', desc: 'Прямоугольный стол у стены, подходит для семьи.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+4' },
    '5': { title: 'Стол 5 (4 чел.)', desc: 'Прямоугольный стол у стены, подходит для семьи.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+5' },
    '6': { title: 'Стол 6 (4 чел.)', desc: 'Прямоугольный стол у стены, подходит для семьи.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+6' },
    '7': { title: 'Стол 7 (4 чел.)', desc: 'Прямоугольный стол в тихом углу.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+7' },
    '8': { title: 'Стол 8 (4 чел.)', desc: 'Прямоугольный стол, ближе к выходу.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+8' },
    '9': { title: 'Стол 9 (4 чел.)', desc: 'Прямоугольный стол в тихом углу.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+9' },
    '10': { title: 'Стол 10 (4 чел.)', desc: 'Прямоугольный стол, ближе к выходу.', photo: 'https://placehold.co/400x200/5D6D7E/E2D2B0?text=Терраса+Стол+10' },
    // ОСНОВНОЙ ЗАЛ (Столы 11-20) - ОБНОВЛЕНО С ОПИСАНИЯМИ
    '11': { title: 'Стол 11 (2-4 чел.)', desc: 'Уютный круглый стол у бара, идеален для небольшой компании.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+11' },
    '12': { title: 'Стол 12 (2-4 чел.)', desc: 'Уютный круглый стол у бара с видом на зал.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+12' },
    '13': { title: 'Стол 13 (6 чел.)', desc: 'Большой прямоугольный стол в центре зала, для компаний до 6 человек.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+13' },
    '14': { title: 'Стол 14 (4 чел.)', desc: 'Круглый стол у колонны, создает атмосферу уединения.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+14' },
    '15': { title: 'Стол 15 (4 чел.)', desc: 'Круглый стол у колонны, удобен для бесед.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+15' },
    '16': { title: 'Стол 16 (4 чел.)', desc: 'Прямоугольный стол у стены с мягкими диванами.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+16' },
    '17': { title: 'Стол 17 (4 чел.)', desc: 'Прямоугольный стол в середине зала, с хорошим обзором.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+17' },
    '18': { title: 'Стол 18 (4 чел.)', desc: 'Прямоугольный стол у стены, идеально для небольшой группы.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+18' },
    '19': { title: 'Стол 19 (6 чел.)', desc: 'Большой круглый стол в дальней части зала, подходит для семейного ужина.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+19' },
    '20': { title: 'Стол 20 (6 чел.)', desc: 'Большой круглый стол, идеален для компании друзей.', photo: 'https://placehold.co/400x200/3E4646/E2D2B0?text=Зал+Стол+20' },
};
...
function showTableDetails(tableId, isBooked = false) {
    ...
    const info = TABLE_DETAILS[tableId] || { 
        ...
        photo: DEFAULT_TABLE_IMAGE // Используем дефолтное фото, если в TABLE_DETAILS нет
    };
    ...
    if (tablePhoto) {
        tablePhoto.src = info.photo || DEFAULT_TABLE_IMAGE; // Используем фото из TABLE_DETAILS, если есть, иначе дефолтное
