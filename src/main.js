...
if (phoneInput) {
    ...
    const minLength = fixedPrefix.length; // 6 символов

    // 1. Устанавливаем начальное значение при фокусе, если поле пустое
    ...
    // 2. Основная логика форматирования и фиксации префикса
